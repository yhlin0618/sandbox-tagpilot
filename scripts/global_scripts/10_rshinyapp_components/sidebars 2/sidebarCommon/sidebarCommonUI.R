# UI Module for Common Sidebar
# Following P21 component n-tuple pattern

#' Sidebar UI with Common Filters
#'
#' Creates a sidebar UI component with common filters that appear in all tabs
#' along with tab-specific filter sections.
#'
#' @param id The module ID
#' @return A dashboardSidebar component with common and tab-specific filter sections
#' @export
sidebarCommonUI <- function(id) {
  ns <- NS(id)
  ...
  bs4Dash::dashboardSidebar(
    ...
    # HIDDEN-FEATURE (2025-04-06): Settings button at bottom of sidebar
