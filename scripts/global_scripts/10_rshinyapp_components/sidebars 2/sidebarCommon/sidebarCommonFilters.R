# Filter Functions for Common Sidebar
# Following P21 component n-tuple pattern

#' Filter data based on common sidebar inputs
#'
#' Apply filters from the common sidebar to datasets
#'
...
#' @export
apply_sidebar_common_filters <- function(data, filter_values, tab = "micro") {
...
filter_micro_data <- function(data, filter_values) {
  return(apply_sidebar_common_filters(data, filter_values, "micro"))
}
...
filter_macro_data <- function(data, filter_values) {
  return(apply_sidebar_common_filters(data, filter_values, "macro"))
}
...
filter_target_data <- function(data, filter_values) {
  return(apply_sidebar_common_filters(data, filter_values, "target"))
}