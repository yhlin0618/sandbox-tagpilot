...
server <- function(input, output, session){
  ...
  output$dynamic_filter <- renderUI({ switch(input$sidebar_menu,
                                             ...
                                             "microMacroKPI" = micro_macro_kpi_comp$ui$filter, NULL) })
  ...
  observeEvent(input$sidebar_menu, {
    ...
    if (input$sidebar_menu %in% c("dna", "position", "positionDNA", "positionMS", "positionKFE", "positionIdealRate", "positionStrategy", "microMacroKPI")) {
